...
# st.write("""
# Welcome to the Growth Mindset Challenge Created by "ERUM WARIS"! This app is designed to help you develop a growth mindset, 
# embrace challenges, and achieve your goals. Let's get started!
# """)

# # Sidebar for navigation
# st.sidebar.title("Navigation")
# page = st.sidebar.radio("Go to", ["Home", "Daily Challenge", "Reflection Journal", "Goal Setting", "Progress Tracker", "Motivational Quotes"])
...
#     perseverance, and learning from your mistakes. It's about embracing challenges, learning from feedback, 
#     and celebrating effort over results.
#     """)
...
#         st.success(f"{reflection}... My Reflection saved!🌻")
...
#             f.write(f"{goal} ({timeline})\n\n")
#         st.success(f"{goal} My Goal is Saved! 🌻")
